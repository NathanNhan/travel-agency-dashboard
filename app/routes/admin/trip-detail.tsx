    ...
    <main className="travel-detail wrapper">
      ...
      <section className="container wrapper-md">
        ...
        <section className="gallery">{imageUrls.map((url: string, i: number) => (
            <img src={url} key={i} className={cn('w-full rounded-xl object-center', i === 0 ? 'md:col-span-2 md:row-span-2 h-[330px]' : 'md:row-span-1 h-[150px]')}  />
        ))}
        </section>
                ...
                <ChipsDirective>
                    {pillItems.map((pill, i) => (
                        <ChipDirective
                            ...
                            cssClass={`${pill.bg} !text-base !font-mediun !px-4`}
